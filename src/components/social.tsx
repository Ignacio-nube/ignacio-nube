...
const Social = ({ github, linkedin, discord, whatsapp }: SocialProps) => {
  const handleDiscordClick = (e: React.MouseEvent) => {
    e.preventDefault();
    navigator.clipboard.writeText(discord);
    toaster.create({
      title: "Discord copiado",
      description: `Usuario ${discord} copiado al portapapeles`,
      type: "success",
    })
  };
  ...
  return (
    <StyledWrapper>
      <div className="card">
        {/* WhatsApp */}
        <a href={whatsapp} target="_blank" rel="noopener noreferrer" className="social-link1">
        ...
        {/* GitHub */}
        <a href={github} target="_blank" rel="noopener noreferrer" className="social-link2">
        ...
        {/* Discord */}
        <a href="#" onClick={handleDiscordClick} className="social-link3">
        ...
        {/* LinkedIn */}
        <a href={linkedin} target="_blank" rel="noopener noreferrer" className="social-link4">
